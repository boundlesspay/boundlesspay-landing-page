        ...
        <div class="col-lg-4  col-sm-4 col-md-4">
          ...
          <div class="row">
            <div class="col-12 col-sm-12">
              <div class="">
                <div>
                  <img loading="lazy" src="~/assets/img/Logo (primary).png" width="288px" class="img-fluid ml-lg-n4" alt="">
                </div>
              </div>
...
export default {
  ...
  methods: {
    setFocus() {
      document.getElementById("form-wrap").focus()
    },
    showSuccess(){
      showSuccessModal('Subscribed', 'You will be notified.')
    }
  },
  mounted(){
